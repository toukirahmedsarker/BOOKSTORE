			   ...
			   $title= mysqli_real_escape_string($db, $_POST['title']);
				...
				$date = date("Y-m-d");
			  	...
			  	if (mysqli_query($db, $sql)) {
				    ...
				    $sql = "INSERT INTO exchange_book (book_id, title, author, type, edition, numpage, language, quantity, status, description, imagepath,upload_date) 
			  			  VALUES('$book_id','$title', '$author', '$type','$edition','$numpage','$language','$quantity','$book_status','$description','$imagepath','$date')";
				    if (mysqli_query($db, $sql)) {
				    			echo "New record created successfully";
				 		}
				 		else {
